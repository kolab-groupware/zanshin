...
K_PLUGIN_FACTORY(PartFactory, registerPlugin<TasksPart>();)
K_EXPORT_PLUGIN(PartFactory(App::getAboutData()))

TasksPart::TasksPart(QWidget *parentWidget, QObject *parent, const QVariantList &)
    : KParts::ReadOnlyPart(parent)
{
    ...
    setXMLFile(KStandardDirs::locate("data", "zanshin/zanshin-tasks_part.rc"));
}
