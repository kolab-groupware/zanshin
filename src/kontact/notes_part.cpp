...
K_PLUGIN_FACTORY(PartFactory, registerPlugin<NotesPart>();)
K_EXPORT_PLUGIN(PartFactory(App::getAboutData()))

NotesPart::NotesPart(QWidget *parentWidget, QObject *parent, const QVariantList &)
